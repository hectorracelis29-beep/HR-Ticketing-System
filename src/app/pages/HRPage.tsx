                ...
                <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-8 border-b border-gray-100">
                      <h3 className="text-xl font-bold flex items-center gap-2">
                        <Zap className="w-5 h-5 text-[#B0BF00]" />
                        Workflow Automation
                      </h3>
                      <p className="text-sm text-gray-500 mt-1">Configure how tickets are assigned and handled.</p>
                    </div>
                    <div className="p-8 space-y-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold">Auto-Route Assignments</p>
                          <p className="text-sm text-gray-500">Automatically assign new tickets based on your categories.</p>
                        </div>
                        <Toggle 
                          active={settings.autoRoute} 
                          onToggle={() => setSettings(s => ({...s, autoRoute: !s.autoRoute}))} 
                        />
                      </div>
                      <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                        <div>
                          <p className="font-semibold">Out of Office Mode</p>
                          <p className="text-sm text-gray-500">Temporarily stop receiving new ticket assignments.</p>
                        </div>
                        <Toggle 
                          active={settings.outOfOffice} 
                          onToggle={() => setSettings(s => ({...s, outOfOffice: !s.outOfOffice}))} 
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-8 border-b border-gray-100">
                      ...
                      <p className="text-sm text-gray-500 mt-1">Choose when and how you want to be notified.</p>
                    </div>
                    <div className="p-8 space-y-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Get an email for every new ticket assigned to you.</p>
                          </div>
                        </div>
                        <Toggle 
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold">SLA Breach Alerts</p>
                            <p className="text-sm text-gray-500">Notify when a ticket is nearing its resolution deadline.</p>
                          </div>
                        </div>
                        <Toggle 
                          active={settings.slaAlerts} 
                          onToggle={() => setSettings(s => ({...s, slaAlerts: !s.slaAlerts}))} 
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-8 border-b border-gray-100">
                      <h3 className="text-xl font-bold flex items-center gap-2">
                        <ShieldCheck className="w-5 h-5 text-[#B0BF00]" />
                        Security & Team
                      </h3>
                      <p className="text-sm text-gray-500 mt-1">Manage permissions and team settings.</p>
                    </div>
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Button variant="outline" className="justify-center py-4 border-dashed">
